...
>
    ...
    >
        <Card.Root class="h-full shadow-2xl border-primary/20">
            {#if loadingAnalysis}
            ...
            {:else}
                <Card.Header
                    class="border-b bg-muted/20 flex flex-row items-center justify-between sticky top-0 z-10"
                >
                    <div>
                ...
                <Card.Content class="overflow-y-auto p-8 custom-scrollbar">
